...
Revision ID: 9f1247b519e1
Revises: 
Create Date: 2022-05-03 14:06:06.596796
...
def upgrade():
    ...
    sa.Column('cate', sa.String(length=16), nullable=False),
    sa.Column('cate2', sa.String(length=16), nullable=False),
    sa.Column('address', sa.String(length=64), nullable=True),
    sa.Column('hpic', sa.String(length=255), nullable=True),
    sa.Column('heat', sa.Float(), nullable=True),
    sa.Column('date', sa.DateTime(), nullable=True),
    sa.Column('source', sa.String(length=32), nullable=True),
    sa.Column('keywords', sa.String(length=255), nullable=True),
    sa.Column('length', sa.Integer(), nullable=True),
    sa.Column('content', sa.Text(length=16777216), nullable=True),
